...
do
    ...
    function pages:PlayerList(info)
        ...
        for Index = 1, 1 do
            ...
            --
            utility:LoadImage(button_gradient, "gradient", "https://i.imgur.com/3YsmCeM.png")
            --
            library.began[#library.began + 1] = function(Input)
        ...
        --
        utility:LoadImage(list_gradient, "gradient", "https://i.imgur.com/3YsmCeM.png")
        --
    ...
    function sections:Toggle(info)
        ...
        --
        utility:LoadImage(toggle__gradient, "gradient", "https://i.imgur.com/3YsmCeM.png")
        --
        function toggle:Get()
        ...
        function toggle:Colorpicker(info)
            ...
            utility:LoadImage(colorpicker__gradient, "gradient", "https://i.imgur.com/3YsmCeM.png")
            --
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", "https://i.imgur.com/3YsmCeM.png")
            --
    ...
    function sections:Slider(info)
        ...
        --
        utility:LoadImage(slider__gradient, "gradient", "https://i.imgur.com/3YsmCeM.png")
        --
    ...
    function sections:TextBox(info)
        ...
        --
        utility:LoadImage(textbox_gradient, "gradient", "https://i.imgur.com/3YsmCeM.png")
        --
    ...
    function sections:Dropdown(info)
        ...
        utility:LoadImage(dropdown__gradient, "gradient", "https://i.imgur.com/3YsmCeM.png")
        --
        if max then
    ...
    function sections:Multibox(info)
        ...
        utility:LoadImage(multibox__gradient, "gradient", "https://i.imgur.com/3YsmCeM.png")
        --
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + (name and 15 or 0) + 20}) and not window:IsOverContent() then
                    ...
                    if not multibox.open then
                        ...
                        for i,v in pairs(multibox.options) do
                            ...
                            --
                            utility:LoadImage(multibox_value_gradient, "gradient", "https://i.imgur.com/3YsmCeM.png")]]
                            --
